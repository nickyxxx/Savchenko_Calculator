...
public class CheckSubtractionButtonActivity {
    ...
    public void checkSubtraction() {
        ...
        checkTextView(R.id.result_tv, "-35");

        clickButton(R.id.button_equals);

        checkTextView(R.id.solution_tv, "-35");
        ...
        checkTextView(R.id.result_tv, "-137");

        checkTextView(R.id.solution_tv, "-137");
    }
    ...
    private void traverseViewTree(View view, String text, OnViewFoundListener listener) {
    ...
    interface OnViewFoundListener {
        void onViewFound(View view, String text);
    }
}
