...
public class CheckMultiplicationButton {
    @Rule
    ...
    public void checkMultiplication() {
        ...
        clickButton(R.id.button_multiply);
        ...
        checkTextView(R.id.result_tv, "294");

        clickButton(R.id.button_equals);

        checkTextView(R.id.solution_tv, "294");
        ...
        checkTextView(R.id.result_tv, "29400");

        checkTextView(R.id.solution_tv, "29400");
    }
