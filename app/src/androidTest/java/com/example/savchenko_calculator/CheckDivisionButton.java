...
public class CheckDivisionButton {
    @Rule
    ...
    public void checkDivision() {
        ...
        clickButton(R.id.button_divide);

        enterDigit("1");
        enterDigit("0");

        checkTextView(R.id.solution_tv, "10/10");

        checkTextView(R.id.result_tv, "1");

        clickButton(R.id.button_equals);

        checkTextView(R.id.solution_tv, "1");
        ...
        checkTextView(R.id.result_tv, "0.01");

        checkTextView(R.id.solution_tv, "0.01");
    }
